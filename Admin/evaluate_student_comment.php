  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>Evaluation Results Comment (Student)</h3>
          </div>
          <div class="col-sm-6">
...
<table id="example11" class="table table-bordered table-hover text-sm">
    ...
    foreach ($combinedValues as $key => $values) {
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-primary btn-xs" href="evaluate_views_comment.php?Id=<?php echo implode(',', $values['ids']); ?>"><i class="fa-solid fa-eye"></i> View</a>
            </td>
        </tr>
        <?php
    }
