	        ...
	        if(is_uploaded_file($_FILES['file']['tmp_name'])){
	            ...
	            while(($line =fgetcsv($csvFile) ) !== FALSE) {
	                ...
	                if($prevResult->num_rows > 0 ) {
	                    $conn->query("UPDATE users SET image = '$image', firstname = '$firstname', gender = '$gender', email = '$email', faculty_status = '$faculty_status', user_type = '$user_type'");
	                } else {
	                    ...
	                    $conn->query("INSERT INTO users(image, firstname, gender, email, faculty_status, user_type, date_registered)
	                    VALUES ('$image', '$firstname', '$gender', '$email', '$faculty_status', '$user_type', NOW() )");
