<title>BPC Faculty Evaluation System | Superior info</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Superior info</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" maxlength="30" placeholder="Juan" name="firstname" required onkeyup="lettersOnly(this)">
                            </div>
                        </div>
                        <div class="col-lg-3 col col-md-6 col-sm-6 col-12">
                          <div class="form-group">
                              <span class="text-dark"><b>Middle name</b></span>
                              <input type="text" class="form-control" maxlength="20" placeholder="Martinez" name="middlename" onkeyup="lettersOnly(this)">
                          </div>
                        </div>
                        <div class="col-lg-3 col col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Last name</b></span>
                              <input type="text" class="form-control" maxlength="30" placeholder="Dela Cruz" name="lastname" required onkeyup="lettersOnly(this)">
                            </div>
                        </div>
                      ...
                      <!--   <div class="col-lg-2 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Superior photo</b></span>
                              <div class="input-group">
                ...
                <div class="card-footer">
                  <div class="float-right">
                    <a href="superior.php" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                    <button type="submit" class="btn bg-primary" name="create_superior" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <form action="process_update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <div class="float-right">
                  <a href="superior.php" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                  <button type="submit" class="btn bg-primary" name="update_superior" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                </div>
              </div>
            </div>
          </form>
