          ...
          <div class="card-body">
            ...
            <table id="example111" class="table table-bordered table-hover text-sm table-sm">
              ...
              <tbody>
                ...
                <tr>
                  <td>3. Implements school's rules and regulations particularly in wearing ID and proper uniform. (Ipinatutupad ang batas at panuntunan ng paaralan lalo na sa pagsusuot ng ID at tamang uniporme). </td>
