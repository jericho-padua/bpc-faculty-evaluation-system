                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="evaltion_history">
                    ...
                    <img src="../images/bpc.ico" alt="logo" width="100" height="100">
                        <p class="ml-2 mt-3">Bulacan Polytechnic College<br>Bulihan, City of Malolos, Bulacan <br> <span class="text-sm text-muted"><b>Printed by:</b> BPC Admin <?= date('Y-m-d h:i A') ?><br><?php if(mysqli_num_rows($active) > 0) { echo $activeId['year'].': '.$activeId['semester']; } else { echo 'Evaluation: OFF'; } ?></span></p>
                    </div>
                    <hr>
