              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="printElement">
                    ...
                    <hr>
                    <p class=""><b>Instructor Name:</b> <?php echo ($fac['firstname'].' '.$fac['middlename'].' '.$fac['lastname'].' '.$fac['suffix']); ?></p>
                    <p class=""><b>Section:</b> <?php echo ($fac ['department'].' '.$fac['yr_level'].' - '.$fac['section']); ?></p>
                    <p class=""><b>Subject:</b> <?php echo ($fac ['code'].' - '.$fac['name']); ?></p>
