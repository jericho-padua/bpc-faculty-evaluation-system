<title>BPC Faculty Evaluation System | Profile</title>
<?php 
    include 'navbar.php'; 
?>
                ...
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="viewprofile">
                    <?php if($row['user_type'] == 'Student'): ?>
                      ...
                      <?php else: ?>
                      <div class="form-group row">
                        <label for="Department" class="col-sm-2 col-form-label">Course</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="Department" placeholder="Course" value="<?php echo $row['department']; ?>" readonly>
                        </div>
                      </div>
                      <?php endif; ?>
                    <?php endif; ?>
                  ...
                  <div class="tab-pane" id="updateprofile">
                    ...
                    <?php endif; ?>
                      ...
                      <div class="form-group row">
                        <label for="email" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="email" name="email" placeholder = "Email" required onkeydown="validation()" onkeyup="validation()"  value="<?php echo $row['email']; ?>">
